...
return (_ctx: any,_push: any,_parent: any,_attrs: any) => {
  ...
  _push(`<div class="full-page" data-v-HomeView-ssr><div class="full-page__row" data-v-HomeView-ssr><div class="full-page__unit" data-v-HomeView-ssr><div class="page-content__row" data-v-HomeView-ssr><div class="homepage-search" data-v-HomeView-ssr><h2 data-v-HomeView-ssr><span lang="zh" data-v-HomeView-ssr>搜尋演講與發言</span><span lang="en" data-v-HomeView-ssr>Search speeches and statements</span></h2><form class="site-search site-search--homepage" action="/search/" method="get" data-v-HomeView-ssr><div class="search-wrapper" data-v-HomeView-ssr><input type="search" class="site-search__input" placeholder="Search" name="q" data-v-HomeView-ssr><input type="submit" class="icon-search icon-search" value="Search" data-v-HomeView-ssr></div></form></div></div></div></div><div class="homepage-stats" data-v-HomeView-ssr><div class="full-page__row" data-v-HomeView-ssr><div class="full-page__unit" data-v-HomeView-ssr><a href="/speeches" data-v-HomeView-ssr><strong data-v-HomeView-ssr>${
    _ssrInterpolate(__props.speechesCount)
  }</strong></a> <span lang="zh" data-v-HomeView-ssr>篇演講</span><span lang="en" data-v-HomeView-ssr>speeches</span>; <a href="/speakers" data-v-HomeView-ssr><strong data-v-HomeView-ssr>${
