...
return (_ctx: any,_push: any,_parent: any,_attrs: any) => {
  ...
  _push(`<div class="full-page"><div class="full-page__row"><div class="full-page__unit"><div class="page-header"><h1><span lang="zh">對話</span><span lang="en">Speeches</span></h1></div><!-- Pagefind search widget --><div id="sayit-search" class="sayit-search" role="search"><div class="sayit-search__input-wrap"><input id="sayit-search-input" type="search" class="sayit-search__input" autocomplete="off" spellcheck="false" aria-label="Search speeches"><span class="sayit-search__shortcut" id="sayit-search-shortcut" aria-hidden="true">/</span></div><div id="sayit-search-results" class="sayit-search__results" aria-live="polite" hidden></div></div><ul class="unstyled" id="sayit-speech-list"><!--[-->`)
