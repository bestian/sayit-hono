...
return (_ctx: any,_push: any,_parent: any,_attrs: any) => {
  ...
  _push(`<div id="sayit-search-results" class="sayit-search__results" aria-live="polite" hidden></div><div class="full-page"><div class="full-page__row"><div class="full-page__unit"><h1 class="search-title-with-result"><span lang="zh">搜尋</span><span lang="en">Search</span> / <strong>${
